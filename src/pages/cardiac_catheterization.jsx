...
function CardiacCatheterization() {
            ...
            <div className='body'>
                <div className='sidebar'>
                    <div className='sidebar-container'>
                        ...
                        <div className='item'>
                            <ul>
                                <li className='active'><Trans i18nKey='sidebar.procedure.angiogram' components={{1:<br/>}}/></li>
                                <li><a href='/procedure/cardiac_evaluation'>{t('sidebar.procedure.cardiacEvaluation')}</a></li>
                    ...
                    <div className='main-container'>
                        <div className='main-body'>
                            ...
                            <div className='encyclopedia'>
                                <p className='encyclopedia-title'><span>{t('procedure.cardiacCatheterization.ko')}</span><br/><span>{t('procedure.cardiacCatheterization.en')}</span></p>
                                <div className='encyclopedia-body'>
                                    ...
                                    <p><span>{t('procedure.cardiacCatheterization.desc1')}</span><br/><span>{t('procedure.cardiacCatheterization.desc2')}</span></p>
                                </div>
